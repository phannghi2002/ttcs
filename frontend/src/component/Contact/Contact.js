    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('img-map')}>
                <a className={cx('img-link')} href="https://www.google.com/maps/@20.9809004,105.7962207,17z?entry=ttu">
            ...
            <div className={cx('information')}>
                <div className={cx('information-list')}>
                    <ul>
                        ...
                        <li className={cx('information-item')}>141 Chiến Thắng, Tân Triều, Thanh Trì, Hà Nội</li>
                    </ul>
                    <ul>
                        <h6 className={cx('information-titles')}>THÔNG TIN LIÊN HỆ: </h6>
                        <li className={cx('information-item')}>Điện thoại: (024/028) 7300 1133</li>
                        <li className={cx('information-item')}>Fax : 024 3726 5463</li>
                        <li className={cx('information-item')}>Hotline : 1900 6432</li>
                        <li className={cx('information-item')}>Email : booking@flynow.vn</li>
                    </ul>
                    <ul>
                        <h6 className={cx('information-titles')}>THỜI GIAN LÀM VIỆC </h6>
                        <li className={cx('information-item')}>Thứ 2 - Thứ 7 : Từ 7h45 - 21h00</li>
                        <li className={cx('information-item')}>Chủ nhật : Từ 8h00 - 20h30</li>
                        <li className={cx('information-item')}>Ngày lễ : Từ 8h00 - 17h30</li>
                    </ul>
                </div>
                <span>
