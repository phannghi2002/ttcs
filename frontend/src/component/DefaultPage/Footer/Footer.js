            ...
            <div className={cx('container')}>
                <div className={cx('infor')}>
                    ...
                    <div className={cx('info-content')}>
                        ...
                        <span className={cx('infor-title')}>141 Chiến Thắng, Tân Triều, Thanh Trì, Hà Nội</span>
                    </div>
                    <div className={cx('info-content')}>
                        <FontAwesomeIcon icon={faPhone} />
                        <span className={cx('infor-title')}>1900 6432 | 024 3726 5463 | (024/028) 7300 1133</span>
                    </div>
                    <div className={cx('info-content')}>
