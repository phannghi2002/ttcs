...
import styles from './InforFlight.module.scss';
            ...
            <div className={cx('container_3')}>
                ...
                {!select && (
                    <span className={cx('ms-3')}>
                        ...
                        <Link to="check">
                            <Button className={cx('select')} onClick={handleSelect}>
