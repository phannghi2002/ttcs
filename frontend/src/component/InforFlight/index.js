...
function InforFlight({ item, name }) {
    const [moneyAdult, setMoneyAdult] = useState(item.Oneway.BusinessClass.PriceAdult);
    const [moneyChildren, setMoneyChildren] = useState(item.Oneway.BusinessClass.PriceChildren);
        ...
        <div className="wrapper ms-3">
            <div className="container_1 me-3">
                <div className="info">
                    ...
                    <div className="duration">{duration(FlightTime, LandingTime)}</div>
