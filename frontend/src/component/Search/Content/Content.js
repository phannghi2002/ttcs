        ...
        <div className={cx("feedback")}>
          ...
          <div className={cx("feedback-item")}>
            ...
            <span className={cx("feedback-title", "mr-106")}>
              "Tôi thích đặt vé máy bay tại flynow bởi lẽ ưu điểm của công ty
              như: nhanh chóng ,chính xác ,tiện lợi ,tiết kiệm .Nhân viên làm
              việc trực tuyến rất chuyên môn ,phong cách phục vụ "tuyệt vời "
              chúc cho flynow ngày càng phát triển"
            </span>
          </div>
          <div className={cx("feedback-item")}>
            <div className={cx("feedback-user")}>
            ...
            <span className={cx("feedback-title", "mr-106")}>
              Mình là một khách hàng đã giao dịch nhiều với đại lý flynow và
              thấy công ty phục vụ rất tốt và chuyên nghiệp. dù chỉ liên lạc qua
              điện thoại nhưng tính an toàn cao và cảm thấy rất hài lòng"
            </span>
          </div>
          <div className={cx("feedback-item")}>
            <span className={cx("feedback-title", "ml-106")}>
              "Mình thường xuyên phải đi công tác Hà Nội - Hồ Chí Minh. Trước
              kia mua vé của một số đại lý offline giá cao hơn nhiều so với
              flynow. Dịch vụ bên bạn hỗ trợ khách hàng rất tốt, từ nay sẽ đặt
              online trên web flynow là chính, vừa nhanh vừa tiện "
            </span>
            <div className={cx("feedback-user")}>
              <img
                ...
                className={cx("feedback-img")}
              />
              <span className={cx("feedback-gmail")}>
                maihoa.ng***@gmail.com
              </span>
            </div>
          </div>
          <div className={cx("feedback-item")}>
            <span className={cx("feedback-title", "ml-106")}>
              "Khách quen của flynow cũng được hơn 1 năm rồi, trừ vài lần có lẽ
              do khách đông quá các bạn k kịp nghe đt ra thì k có gì đáng phàn
              nàn cả. Rất chu đáo!"
            </span>
            <div className={cx("feedback-user")}>
              <img
